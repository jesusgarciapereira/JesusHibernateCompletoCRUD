					...
					case 3: // 3. Matriculas.
						if (FuncionesProfesores.buscaIDsDeTodos().isEmpty()
							...
							if (FuncionesProfesores.buscaIDsDeTodos().isEmpty()) {
								...
								System.out.println("Guarde al menos un Profesor antes de guardar una Matricula");
								System.out.println();
							}
							if (FuncionesAlumnos.buscaIDsDeTodos().isEmpty()) {
								System.out.print(ColorMio.getRojo());
								...
								System.out.print("Consejo: ");
								System.out.print(ColorMio.getReset());
								System.out.println("Guarde al menos un alumno antes de guardar una Matricula");
								System.out.println();
							}
						} else {
							do {
						...
						if (!FuncionesProfesores.buscaIDsDeTodos().isEmpty()) {
							do {
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsProfesores.size() > 1) {
												...
												if (idDeCambio != 0) {
													...
													if (idsProfesores.contains(idDeCambio)
															&& FuncionesProfesores.actualizarPorId(idDeCambio,
																	columnaCambiada, datoCambiado)) {
														System.out.print(ColorMio.getVerde());
														System.out.print(
																"Profesor con ID = " + idDeCambio + " tiene ahora "
																		+ columnaCambiada + " = " + datoCambiado);
														System.out.print(ColorMio.getReset());
														System.out.println();
														...
														System.out.print(ColorMio.getRojo());
														System.out.print("No existe ningún Profesor con ID = "
												...
												System.out.print(ColorMio.getVerde());
												System.out.print("Profesor con nombre = " + datoDeCambio
												...
												System.out.print(ColorMio.getRojo());
												System.out.print(
														"No existe ningún Profesor con nombre = " + datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
								...
								case 3: // 3. Por apellidos.
									do {
										System.out
												.print("Introduzca los Apellidos del Profesor que quiera Actualizar: ");
										datoDeCambio = sc.nextLine();
									} while (datoDeCambio == "" || datoDeCambio == null);
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsProfesores.size() > 1) {
												...
												if (idDeCambio != 0) {
													...
													System.out.print(ColorMio.getVerde());
													System.out.print("Todos los Profesores con apellidos = "
												...
												System.out.print(ColorMio.getRojo());
												System.out.print(
														"No existe ningún Profesor con apellidos = " + datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
									...
									do {
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsProfesores.size() > 1) {
												...
												FuncionesProfesores
														.leerPorFechaNacimiento(LocalDate.parse(datoDeCambio), "=");
...
//												}
												...
												System.out.print(ColorMio.getRojo());
												System.out.print("No existe ningún Profesor con fechaNacimiento = "
														+ datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsProfesores.size() > 1) {
												...
												if (idDeCambio != 0) {
													...
													System.out.print(ColorMio.getVerde());
													System.out.print("Todos los Profesores con antiguedad = "
															+ datoDeCambio + " tienen ahora " + columnaCambiada + " = "
															+ datoCambiado);
													System.out.print(ColorMio.getReset());
													System.out.println();
					...
					case 2: // 2. Alumnos.
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsAlumnos.size() > 1) {
												...
												if (idDeCambio != 0) {
													...
													if (idsAlumnos.contains(idDeCambio)
															&& FuncionesAlumnos.actualizarPorId(idDeCambio,
																	columnaCambiada, datoCambiado)) {
														System.out.print(ColorMio.getVerde());
														System.out
																.print("Alumno con ID = " + idDeCambio + " tiene ahora "
																		+ columnaCambiada + " = " + datoCambiado);
														System.out.print(ColorMio.getReset());
														System.out.println();
														...
														System.out.print(ColorMio.getRojo());
														System.out.print("No existe ningún Alumno con ID = "
																+ idDeCambio + " en la lista anteriormente mostrada");
														System.out.print(ColorMio.getReset());
														System.out.println();
									...
									do {
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsAlumnos.size() > 1) {
												...
												System.out.print(ColorMio.getAmarillo());
												System.out
														.println("Hay varios Alumnos con apellidos = " + datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
												...
												System.out.print(ColorMio.getVerde());
												System.out.print("Alumno con apellidos = " + datoDeCambio
														+ " tiene ahora " + columnaCambiada + " = " + datoCambiado);
												System.out.print(ColorMio.getReset());
												System.out.println();
												...
												System.out.print(ColorMio.getRojo());
												System.out.print(
														"No existe ningún Alumno con apellidos = " + datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
									...
									do {
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsAlumnos.size() > 1) {
												...
												System.out.print(ColorMio.getRojo());
												System.out.print("No existe ningún Alumno con fechaNacimiento = "
														+ datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
						...
						break; // FIN 2. Alumnos.
					case 3: // 3. Matriculas.
						if (!FuncionesMatriculas.buscaIDsDeTodos().isEmpty()) {
							do {
								...
								case 1: // 1. Por idMatricula.
									...
									do {
										System.out.print(
												"Introduzca el ID de la Matricula que quiera Actualizar (> 0): ");
										idDeCambio = leeLong(sc);
									} while (idDeCambio <= 0);
										...
										if (opcionSubmenuC != 0) {
											...
											if (!FuncionesMatriculas.buscaIDsDeTodos().contains(idDeCambio)) {
												...
												if (columnaCambiada.equals("idProfesor") && !FuncionesProfesores
													...
													System.out.print(ColorMio.getRojo());
													System.out.print(
															"No existe ningún Profesor con ID = " + datoCambiado);
													System.out.print(ColorMio.getReset());
													System.out.println();
													...
													System.out.print(ColorMio.getRojo());
													System.out
															.print("No existe ningún Alumno con ID = " + datoCambiado);
													System.out.print(ColorMio.getReset());
													System.out.println();
												} else {
									...
									do {
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsMatriculas.size() > 1) {
												...
												FuncionesMatriculas.leerPorProfesor(FuncionesProfesores
														.getProfesorPorId(Long.valueOf(datoDeCambio)), cabecera);

												System.out.print(ColorMio.getAmarillo());
												System.out.print(
														"Hay varias Matriculas con idProfesor = " + datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
												...
												if (idDeCambio != 0) {
													if (idsMatriculas.contains(idDeCambio)
															&& FuncionesMatriculas.actualizarPorId(idDeCambio,
																	columnaCambiada, datoCambiado)) {

														System.out.print(ColorMio.getVerde());
														System.out.print(
																"Matricula con ID = " + idDeCambio + " tiene ahora "
																		+ columnaCambiada + " = " + datoCambiado);
														System.out.print(ColorMio.getReset());
														System.out.println();
													} else {
									...
									do {
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsMatriculas.size() > 1) {
												...
												System.out.print(ColorMio.getAmarillo());
												System.out
														.print("Hay varias Matriculas con idAlumno = " + datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
									...
									do {
										...
										if (opcionSubmenuC != 0) {
											...
											if (idsMatriculas.size() > 1) {
												...
												System.out.print(ColorMio.getAmarillo());
												System.out.print(
														"Hay varias Matriculas con asignatura = " + datoDeCambio);
												System.out.print(ColorMio.getReset());
												System.out.println();
												...
												if (idDeCambio != 0) {
													...
													System.out.print(ColorMio.getVerde());
													System.out.print("Todas las Matriculas con asignatura = "
															+ datoDeCambio + " tienen ahora " + columnaCambiada + " = "
															+ datoCambiado);
													System.out.print(ColorMio.getReset());
													System.out.println();
			...
			case 4: // 4. Borrar Datos.
				do {
					...
					case 2: // 2. Profesores.
						do {
							...
							case 4: // 4. Por apellidos.
								...
								if (sc.nextLine().equals("s")) {
									...
									if (idsProfesores.size() > 1) {
										...
										System.out.print(ColorMio.getAmarillo());
										System.out
												.print("Hay varios Profesores con apellidos = '" + datoDeBorrado + "'");
										System.out.println(ColorMio.getReset());
										...
										if (idDeBorrado != 0) {
											...
											if (sc.nextLine().equals("s")) {
												...
												System.out.print(ColorMio.getVerde());
												System.out.print("Todos los Profesores con apellidos = '"
														+ datoDeBorrado + "' han sido borrados");
												System.out.println(ColorMio.getReset());
											}
							...
							case 5: // 5. Por fechaNacimiento.
								...
								System.out.println();
								System.out
										.println("¿Está seguro de que quiere borrar al Profesor con fechaNacimiento = '"
												+ datoDeBorrado + "'? (s/n)");
								System.out.print(ColorMio.getAmarillo());
								System.out.print(
										"ADVERTENCIA: Se borrarán también las Matriculas asociadas a dicho Profesor");
								...
								if (sc.nextLine().equals("s")) {
									...
									if (idsProfesores.size() > 1) {
										...
										FuncionesProfesores.leerPorFechaNacimiento(LocalDate.parse(datoDeBorrado), "=");

										System.out.print(ColorMio.getAmarillo());
										System.out.print(
												"Hay varios Profesores con fechaNacimiento = '" + datoDeBorrado + "'");
										System.out.println(ColorMio.getReset());
										...
										if (idDeBorrado != 0) {
											...
											System.out.println(
													"¿Está seguro de que quiere borrar a todos estos Profesores con fechaNacimiento = '"
															+ datoDeBorrado + "'? (s/n)");
										...
										System.out.print(ColorMio.getVerde());
										System.out.print(
												"Profesor con fechaNacimiento = '" + datoDeBorrado + "' borrado");
										System.out.println(ColorMio.getReset());
									} else {
										System.out.print(ColorMio.getRojo());
										System.out.print("No existe ningún Profesor con fechaNacimiento = '"
							...
							case 6: // 6. Por antiguedad.
								do {
									System.out
											.print("Introduzca la Antiguedad del Profesor que quiera Borrar (>= 0): ");
									antiguedad = leeInt(sc);
									if (antiguedad >= 0) {
										datoDeBorrado = String.valueOf(antiguedad);
									}
								} while (datoDeBorrado == null || datoDeBorrado.equals(""));

								System.out.println();
								System.out.println("¿Está seguro de que quiere borrar al Profesor con antiguedad = "
										+ datoDeBorrado + "? (s/n)");
								System.out.print(ColorMio.getAmarillo());
								System.out.print(
										"ADVERTENCIA: Se borrarán también las Matriculas asociadas a dicho Profesor");
								...
								if (sc.nextLine().equals("s")) {
									...
									idsProfesores = FuncionesProfesores.buscaIDsPorColumna("antiguedad", datoDeBorrado);

									if (idsProfesores.size() > 1) {

										FuncionesProfesores.leerPorAntiguedad(Integer.parseInt(datoDeBorrado), "=");

										System.out.print(ColorMio.getAmarillo());
										System.out.print("Hay varios Profesores con antiguedad = " + datoDeBorrado);
										System.out.println(ColorMio.getReset());
										...
										if (idDeBorrado != 0) {
											...
											System.out.println(
													"¿Está seguro de que quiere borrar a todos estos Profesores con antiguedad = "
															+ datoDeBorrado + "? (s/n)");
										...
										System.out.print(ColorMio.getVerde());
										System.out.print("Profesor con antiguedad = " + datoDeBorrado + " borrado");
										System.out.println(ColorMio.getReset());
									} else {
										System.out.print(ColorMio.getRojo());
										System.out.print("No existe ningún Profesor con antiguedad = " + datoDeBorrado);
										System.out.println(ColorMio.getReset());
									}
								}
					...
					case 3: // 3. Alumnos.
						do {
							Menu.subMenuElegirAlumnoBorrar();
							opcionSubmenuB = leeInt(sc);
							System.out.println();
							...
							case 2: // 2. Por idAlumno
								do {
									System.out.print("Introduzca el ID del Alumno que quiera Borrar (> 0): ");
									idDeBorrado = leeLong(sc);
								} while (idDeBorrado <= 0);

								System.out.println();

								System.out.println("¿Está seguro de que quiere borrar al Alumno con ID = " + idDeBorrado
										+ "? (s/n)");
								System.out.print(ColorMio.getAmarillo());
								System.out.print(
								...
								if (sc.nextLine().equals("s")) {
									...
									if (FuncionesAlumnos.borrarPorId(idDeBorrado)) {
										System.out.print(ColorMio.getVerde());
										System.out.print("Alumno con ID = " + idDeBorrado + " ha sido borrado");
										System.out.println(ColorMio.getReset());
									} else {
										System.out.print(ColorMio.getRojo());
							...
							case 3: // 3. Por nombre.
								...
								if (sc.nextLine().equals("s")) {
									...
									if (idsAlumnos.size() > 1) {
										...
										System.out.print(ColorMio.getRojo());
										System.out
												.print("No existe ningún Alumno con nombre = '" + datoDeBorrado + "'");
										System.out.println(ColorMio.getReset());
									}
								}
							...
							case 4: // 4. Por apellidos.
								...
								do {
									System.out.print("Introduzca los Apellidos del Alumno que quiera Borrar: ");
									datoDeBorrado = sc.nextLine();
								} while (datoDeBorrado == "" || datoDeBorrado == null);

								System.out.println();

								System.out.println("¿Está seguro de que quiere borrar al Alumno con apellidos = '"
										+ datoDeBorrado + "'? (s/n)");
								System.out.print(ColorMio.getAmarillo());
								System.out.print(
										"ADVERTENCIA: Se borrarán también las Matriculas asociadas a dicho Alumno");
								...
								if (sc.nextLine().equals("s")) {
									...
									idsAlumnos = FuncionesAlumnos.buscaIDsPorColumna("apellidos", datoDeBorrado);

									if (idsAlumnos.size() > 1) {

										FuncionesAlumnos.leerPorApellidos(datoDeBorrado, "=");

										System.out.print(ColorMio.getAmarillo());
										System.out.print("Hay varios Alumnos con apellidos = '" + datoDeBorrado + "'");
										System.out.println(ColorMio.getReset());
										...
										if (idDeBorrado != 0) {
											...
											System.out.println(
													"¿Está seguro de que quiere borrar a todos estos Alumnos con apellidos = '"
															+ datoDeBorrado + "'? (s/n)");
											...
											if (sc.nextLine().equals("s")) {
												...
												System.out.print(ColorMio.getVerde());
												System.out.print("Todos los Alumnos con apellidos = '" + datoDeBorrado
														+ "' han sido borrados");
												System.out.println(ColorMio.getReset());
											}
										...
										System.out.print(ColorMio.getVerde());
										System.out.print("Alumno con apellidos = '" + datoDeBorrado + "' borrado");
										System.out.println(ColorMio.getReset());
									} else {
										System.out.print(ColorMio.getRojo());
										System.out.print(
												"No existe ningún Alumno con apellidos = '" + datoDeBorrado + "'");
										System.out.println(ColorMio.getReset());
									}
								}
							...
							case 5: // 5. Por fechaNacimiento.
								...
								System.out.println();
								System.out.println("¿Está seguro de que quiere borrar al Alumno con fechaNacimiento = '"
										+ datoDeBorrado + "'? (s/n)");
								System.out.print(ColorMio.getAmarillo());
								System.out.print(
										"ADVERTENCIA: Se borrarán también las Matriculas asociadas a dicho Alumno");
								...
								if (sc.nextLine().equals("s")) {
									...
									idsAlumnos = FuncionesAlumnos.buscaIDsPorColumna("fechaNacimiento", datoDeBorrado);

									if (idsAlumnos.size() > 1) {

										FuncionesAlumnos.leerPorFechaNacimiento(LocalDate.parse(datoDeBorrado), "=");

										System.out.print(ColorMio.getAmarillo());
										System.out.print(
												"Hay varios Alumnos con fechaNacimiento = '" + datoDeBorrado + "'");
										System.out.println(ColorMio.getReset());
										...
										if (idDeBorrado != 0) {
											...
											System.out.println(
													"¿Está seguro de que quiere borrar a todos estos Alumnos con fechaNacimiento = '"
															+ datoDeBorrado + "'? (s/n)");
										...
										System.out.print(ColorMio.getVerde());
										System.out
												.print("Alumno con fechaNacimiento = '" + datoDeBorrado + "' borrado");
										System.out.println(ColorMio.getReset());
									} else {
										System.out.print(ColorMio.getRojo());
										System.out.print("No existe ningún Alumno con fechaNacimiento = '"
					...
					case 4: // 4. Matriculas.
						do {
							...
							case 3: // 3. Por idProfesor.
								do {
									System.out.print(
											"Introduzca el IDProfesor de la Matricula que quiera Borrar (>= 0): ");
									idProfesor = leeLong(sc);
									if (idProfesor >= 0) {
								...
								if (sc.nextLine().equals("s")) {
									...
									if (idsMatriculas.size() > 1) {
										...
										if (idDeBorrado != 0) {
											System.out
													.println("¿Está seguro de que quiere borrar la Matricula con ID = "
															+ idDeBorrado + "? (s/n)");
											...
											if (sc.nextLine().equals("s")) {
												...
												if (idsMatriculas.contains(idDeBorrado)
													...
													System.out.print(ColorMio.getRojo());
													System.out.print("No existe ninguna Matricula con ID = "
															+ idDeBorrado + " en la lista anteriormente mostrada");
													System.out.println(ColorMio.getReset());
												}
											}
										...
										System.out.print(ColorMio.getRojo());
										System.out
												.print("No existe ninguna Matricula con idProfesor = " + datoDeBorrado);
										System.out.println(ColorMio.getReset());
									}
								}
									...
									if (idsMatriculas.size() > 1) {
										...
										if (idDeBorrado != 0) {
											...
											if (sc.nextLine().equals("s")) {
												...
												System.out.print(ColorMio.getVerde());
												System.out.print("Todas las Matriculas con idAlumno = " + datoDeBorrado
														+ " han sido borradas");
												System.out.println(ColorMio.getReset());
											}
							...
							case 5: // 5. Por asignatura.
								...
								if (sc.nextLine().equals("s")) {
									...
									if (idsMatriculas.size() > 1) {
										...
										System.out.print(ColorMio.getAmarillo());
										System.out.print(
												"Hay varias Matriculas con asignatura = '" + datoDeBorrado + "'");
										System.out.println(ColorMio.getReset());
							...
							case 6: // 6. Por curso.
								do {
									System.out.print("Introduzca el Curso de la Matricula que quiera Borrar (>= 0): ");
									curso = leeInt(sc);
									if (curso >= 0) {
									...
									if (idsMatriculas.size() > 1) {
										...
										if (idDeBorrado != 0) {
											...
											if (sc.nextLine().equals("s")) {
												...
												System.out.print(ColorMio.getVerde());
												System.out.print("Todas las Matriculas con curso = " + datoDeBorrado
														+ " han sido borradas");
												System.out.println(ColorMio.getReset());
											}
